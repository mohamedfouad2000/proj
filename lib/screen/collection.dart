  ...
  Widget buldd(model, context) => Card(
        ...
        child: Column(
          children: [
            Row(
              children: [
                Text("اسم العميل " , style:Theme.of(context).textTheme.headline1,),
                Spacer(),
                Text("${model['name']} ", style:Theme.of(context).textTheme.headline1,),
                Spacer(),
                Text("التاريخ ",style:Theme.of(context).textTheme.headline1,),
                Spacer(),
                Text("${model['data']} ", style:Theme.of(context).textTheme.headline1,),
              ],
            ),
            SizedBox(
              height: 15,
            ...
            Row(
              children: [
                ...
                Spacer(),
                Text("${model['price']} جنيه" , style:Theme.of(context).textTheme.headline1,),
                Spacer(),
                Text("عدد الاصناف" , style:Theme.of(context).textTheme.headline1,),
                Spacer(),
                Text("${model['numberofp']}" , style:Theme.of(context).textTheme.headline1,),
                Spacer(),
                // Text("${model['name']} "),
              ],
            ),
