...
class edituser extends StatelessWidget {
                                ...
                                Expanded(
                                  child: Align(
                                    ...
                                    child: Title(
                                        color: Colors.orange,
                                        child: Text(
                                            "${homeCubit.get(context).price1} جنيه" , style: Theme.of(context).textTheme.overline,)),
                                  ),
                                ),
                              ],
                            ),
  ...
  Widget prod(productss model, index, context) {
    ...
    return Row(
      ...
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Expanded(child: Text("${model.pro.toString()}  ", style: Theme.of(context).textTheme.overline,)),
        ...
        Expanded(
          child:
              Align(alignment: Alignment.bottomCenter, child: Text("$s جنيه" , style: Theme.of(context).textTheme.overline)),
        ),
        Expanded(
            child: TextButton(
                onPressed: () {
